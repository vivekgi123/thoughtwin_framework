...
from modules.user.business.services.PermissionService import PermissionService


class PermissionServices(PermissionService):
    """_summary_

    Args:
        PermissionService (_type_): _description_
    """
